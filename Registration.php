...
class Registration
{
    ...
    public function __construct()
    {
        try
        {
            ...
            if ($this -> validateInput())
            {
				...
				$this -> soapCommand('bnet create '.$_POST["email"].' '.$_POST["password"]);
    ...
    protected function validateInput()
    {
        ...
        if (!isset($_POST["expansion"]) || $_POST["expansion"] != intval($_POST["expansion"]) || intval($_POST["expansion"]) < 0 || intval($_POST["expansion"]) > 4)
        {
